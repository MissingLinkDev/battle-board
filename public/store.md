...
image: https://battle-board.missinglinkdev.com/screenshots/range-overlays.png
icon: https://battle-board.missinglinkdev.com/icon.svg
tags:
  - tool
  - combat
  - automation
manifest: https://battle-board.missinglinkdev.com/manifest.json
